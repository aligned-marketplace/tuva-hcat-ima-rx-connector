-- Stub: IMA Rx connector has no medical claim data.
-- This empty model satisfies Tuva's dependency graph.
select
    ...
    , cast(null as numeric(38,2)) as paid_amount
    , cast(null as numeric(38,2)) as allowed_amount
    , cast(null as numeric(38,2)) as charge_amount
    , cast(null as numeric(38,2)) as coinsurance_amount
